...
if __name__ == '__main__':
    ...
    parser.add_argument("-w", "--workers_id", help="gpu ids or cpu", default="0,1", type=str)
    parser.add_argument("-e", "--epochs", help="training epochs", default=30, type=int)
    ...
    parser.add_argument("-t", "--target", help="verification targets", default='lfw', type=str) #talfw,calfw,cplfw,cfp_fp,agedb_30
    parser.add_argument("-r", "--resume", help="resume model", default='', type=str)
    parser.add_argument('--outdir', help="output dir", default='./results/vit', type=str)
